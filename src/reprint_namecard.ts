...
export const reprintNamecard = async (successRes: IAddReturn) => {
  console.log(successRes.success.transaction_code);
  console.log(successRes.success.combinations);
  try {
    ...
    async function printCombinationWithSpacing(
      ...
      await SunmiV2Printer.printOriginalText("S3");
